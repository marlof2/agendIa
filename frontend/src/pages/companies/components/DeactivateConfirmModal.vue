<template>
  <BaseDialog
    ...
    subtitle="A empresa não poderá ser utilizada temporariamente"
    icon="mdi-cancel"
    icon-color="warning"
    max-width="500px"
    ...
    @close="closeModal"
  >
    <div v-if="item" class="deactivate-confirm">
      <!-- Warning Icon -->
      ...
      <div class="confirm-message mb-6">
        ...
        <p class="text-body-1 text-center text-medium-emphasis">
          A empresa <strong>"{{ item.name }}"</strong> será inativada e não poderá ser utilizada temporariamente.
        </p>
      </div>
      ...
      <div class="warning-notice mt-4">
        ...
        >
          ...
          <div class="text-body-2">
            <strong>Atenção:</strong> A empresa será inativada e não poderá ser utilizada. Você pode reativá-la a qualquer momento.
          </div>
        </v-alert>
      </div>
    </div>
