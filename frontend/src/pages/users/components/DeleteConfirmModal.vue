              ...
              <v-card-text>
                <div class="d-flex align-center">
                  ...
                  <div>
                    <div class="font-weight-medium text-body-1">
                      {{ item.name || 'Usuário não informado' }}
                    </div>
                ...
                <div class="item-details">
                  <div class="detail-row">
                    ...
                    <span>{{ item.phone ? formatPhone(item.phone) : 'Telefone não informado' }}</span>
                  </div>
                  <div class="detail-row">
                    <v-icon size="16" class="mr-2">mdi-account-tie</v-icon>
                    <span>{{ item.profile?.display_name || item.profile?.name || 'Perfil não informado' }}</span>
                  </div>
                  <div class="detail-row">
                    <v-icon size="16" class="mr-2">mdi-domain</v-icon>
                    <span>{{ item.companies?.length || 0 }} empresa(s) associada(s)</span>
                  </div>
                  <div class="detail-row">
